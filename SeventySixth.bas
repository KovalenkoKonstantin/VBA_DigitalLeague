Attribute VB_Name = "SeventySixth"
Sub SeventySixth()
...
ThisWorkbook.Sheets("Processing 76").Activate
...
Title1 = "Блин!"
MsgBox "Надо указать НДС в столбце AT по красным позициям из столбца S", Style1, Title1
End If
